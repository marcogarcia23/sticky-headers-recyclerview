...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter, DimensionCalculator dimensionCalculator) {
        this(adapter, dimensionCalculator, new HeaderRenderer(),
                new HeaderViewCache(adapter));
    }

    private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter, DimensionCalculator dimensionCalculator, HeaderRenderer headerRenderer, HeaderProvider headerProvider) {
        this(adapter, headerRenderer, dimensionCalculator, headerProvider,
                new HeaderPositionCalculator(adapter, headerProvider, dimensionCalculator));
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mHeaderPositionCalculator.hasNewHeader(itemPosition)) {
            ...
            setItemOffsetsForHeader(outRect, header, LinearLayoutManager.VERTICAL);
        }
    }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            boolean hasStickyHeader = mHeaderPositionCalculator.hasStickyHeader(itemView, LinearLayoutManager.VERTICAL, position);
